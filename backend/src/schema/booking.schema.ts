...
export const AddBookingZodSchema = z.object({
  body: z.object({
    ...
    transaction: z
      ...
      .optional(),
    baseDiscount: z.number(numberErrorHandler("baseDiscount")).optional(),
    deposit: z.number(numberErrorHandler("deposit")).optional(),
    isDeposit : z.boolean(booleanErrorHandler("isDeposit")).optional(),
    depositDiscount : z.number(numberErrorHandler("depositDiscount")).optional(),
