...
<body>
    ...
    <div class="content">
        ...
        <table>
            ...
            <tr>
                <td>(-) Discount &nbsp&nbsp&nbsp&nbsp&nbsp ${props.discountPercent}%</td>
                <td>(${(props.hallCharges + props.additionalFacilities) * (props.discountPercent / 100)})</td>
            </tr>
            <tr>
                <td>Total Hall Charges</td>
                <td>${(props.hallCharges + props.additionalFacilities) * (1 - props.discountPercent / 100)}</td>
            </tr>
            <tr>
                <td>SGST - 9 %</td>
                <td>${props.sgst}</td>
            ...
            <tr>
                <td>Total</td>
                <td>${(props.hallCharges + props.additionalFacilities) * (1 - props.discountPercent / 100) + props.sgst + props.cgst}</td>
            </tr>
            <tr>
                <td>Hall Deposit &nbsp&nbsp&nbsp&nbsp&nbsp Applicable:${props.hallDeposit} &nbsp&nbsp&nbsp&nbsp&nbsp Discount:${props.depositDiscount}%</td>
                <td>${(props.hallDeposit)*(1-props.depositDiscount/100)}</td>
            </tr>
            <tr>
                <td>Total Payable</td>
        ...
        <p>Invoice & Receipt of payment will be emailed at your email ID ${props.email}.For hard copy please contact XXXXX at XXXXX.</p>
    </div>
