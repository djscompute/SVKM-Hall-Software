...
export default function EditAdmin() {
    ...
    const [editableField, setEditableField] = useState<keyof UpdateAdminType | null>(null);
    const [originalAdmin, setOriginalAdmin] = useState<UpdateAdminType | null>(null);
    ...
    const handleFieldChange = (fieldName: keyof UpdateAdminType, value: string) => {
        setValidInput(true)
    ...
    return (
        <div className='p-4'>
            ...
            />
            {
                (admin.role === "MANAGER") &&
                <div className="">
                    <h3 className="block text-lg font-medium text-gray-700">Manage Halls</h3>
                    <p className='text-gray-600 text-sm'>(Add or Remove from actions to change managed halls)</p>
                    <AddHalltoManager
